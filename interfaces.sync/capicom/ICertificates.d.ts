...
export interface ICertificates {
    ...
    // Clear(): void;
    Find(FindType: CAPICOM_CERTIFICATE_FIND_TYPE, varCriteria: any, bFindValidOnly: boolean): ICertificates; // @TODO: расписать по значениям enum'а
    Find(FindType: CAPICOM_CERTIFICATE_FIND_TYPE, varCriteria: any): ICertificates;
